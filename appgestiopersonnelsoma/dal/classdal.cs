...
namespace appgestiopersonnelsoma.dal
{
     public class classdal
    {
        ...
        private static string connectionString = "server=localhost;user id=root;database=appligestiopersonnelsoma;port=3306";
        ...
        public static List<classAbsences> GetAbsences()
        {
            ...
            string req = "select a.datedenuts as datedebuts,a.datefins as datefins, a.idmotifs as idmotifs, a.idpersonnels as idpersonnels";
        ...
        public static void DelPersonnels(classPersonnels personnel)
        {
            ...
            connexiondatabase conn = connexiondatabase.GetInstance(connectionString);
        ...
        //public static List<classResponsables> GetResponsables()
        //{
        //    List<classResponsables> lesResponsables = new List<Profil>();
